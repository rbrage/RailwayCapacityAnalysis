...
% Sets generators
png.set_of_Ps = {'pGenStavanger', 'pGenSandnes', 'pGenNaerbo','pGenEgersund', 'pGenMoi', 'pGenKristiansand', 'pGenDrammen',...
 'pOutStavangerS','pOutSandnes','pOutNaerbo','pOutEgersund', 'pOutKristiansand','pOutDrammen'};

png.set_of_Ts = {'tInStavanger','tInSandnes','tInNaerbo', 'tInEgersund', 'tInMoi','tInKristiansand', 'tInDrammen',...
'tOutStavangerS','tOutSandnes','tOutNaerbo','tOutEgersund','tOutKristiansand','tOutDrammen'};
