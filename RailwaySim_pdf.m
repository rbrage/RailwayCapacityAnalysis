...
% Sets generators
png.set_of_Ps = {'pGenStavanger', 'pGenSandnes', 'pGenNaerbo','pGenEgersund', 'pGenKristiansand', 'pGenDrammen',...
 'pOutStavangerS','pOutSandnes','pOutNaerbo','pOutEgersund','pOutKristiansand','pOutDrammen'};

png.set_of_Ts = {'tInStavanger','tInSandnes','tInNaerbo', 'tInEgersund','tInKristiansand', 'tInDrammen',...
